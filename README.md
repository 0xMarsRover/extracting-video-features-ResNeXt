...
Credit: [repo](https://github.com/kenshohara/video-classification-3d-cnn-pytorch)
...
## Files needed
1. hmdb51_ClassInd.txt
2. hmdb51_input_filename
3. ext_feat_hmdb51.sh
4. change main.py at line 38 (change class index file when using new dataset)

5. if change pre-trained model to 64f, check code "opt.sample_duration = 64", make sure value is 64
